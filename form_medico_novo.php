...
<body>
	...
	<header>
        ...
        <form action="connect_medicos.php" method="post">
            <fieldset>
                <label>Nome do Médico:</label> <input type="text" name="nome" id="nome" required/><br>
            </fieldset>
            <fieldset>
                <label>Especialidade:</label> <input type="text" name="especialidade" id="especialidade" required/><br>
            </fieldset>
            <fieldset>
                <label>Preço:</label> <input type="text" name="preco" id="preco" required/><br>
            </fieldset>
