 ...
 ?>
    ...
    <article>
        ...
        <table id="medicos">
            ...
            <tr><th>Número de Sócio</th><th>Nome  do Sócio</th><th>Especialidade</th><th>Médico</th><th>Observações</th><th>Preço</th></tr>

            <?php

                $query = "select * from procedimentos where Nome='$User'";

                $result = mysqli_query($conn,$query);

                while($row = mysqli_fetch_array($result)){
                    echo "<tr><td>".$row["NumSocio"]."</td><td>".$row["NomeSocio"]."</td><td>".$row["Especialidade"]."</td><td>".$row["Medico"]."</td><td>".$row["CampoTexto"]."</td><td>".$row["Preco"]."</td></tr>";
                }
